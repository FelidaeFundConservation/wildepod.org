...
| Bbox-rejection → child-rejection propagation (`reject_children`) | `siteapps/images/processors/annotation.py`, called from `handle_bbox_deletions()` |
