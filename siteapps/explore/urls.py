...
urlpatterns = [
    ...
    path("data/snapshot/", SnapshotCreateView.as_view(),
         name="data_snapshot_create"),
    ...
    path("popular-images/", ExplorePopularImagesView.as_view(),
         name="popular_images"),
    ...
    re_path("species/sighting/images/$",
            SpeciesSightingImagesView.as_view(), name="species_sighting_images"),
    re_path(
        "species/(?P<species>.+)/$", SpeciesSightingTimeseriesView.as_view(), name="species_sighting_timeserie_list"
    ),
    path("volunteer_engagement/", VolunteerEngagementView.as_view(),
