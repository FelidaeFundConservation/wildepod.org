...
let MDClassSelectorWidget = function(args) {
    ...
    // 2. Keep the value in a letiable
    ...
    let animalButton = createButton('animal');
    let personButton = createButton('person');
    let vehicleButton = createButton('vehicle');
...
*/
function renderBoundingBoxes(imageElementID, annotations, config) {
