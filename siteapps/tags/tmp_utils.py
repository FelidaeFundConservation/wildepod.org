...
# Code from https://github.com/microsoft/CameraTraps/blob/master/visualization/visualization_utils.py
...
def draw_bounding_boxes_on_image(image, boxes, classes, thickness=4, expansion=0, display_strs=()):
    """
...
def draw_bounding_box_on_image(
    ...
    if clss is None:
        ...
        color = COLORS[len(clss) % len(COLORS)]
